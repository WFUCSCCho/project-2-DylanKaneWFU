 ...
 */
class AvlTree<AnyType extends Comparable<AnyType>>
        extends Tree<AnyType> {
    /**
     * Construct the tree.
     */
    public AvlTree( ) {
    ...
    private AvlNode<AnyType> insert( AnyType x, AvlNode<AnyType> t ) {
        ...
        if (this.root == null) {
            this.root = new AvlNode(x, null, null);
            return this.root;
        }
    ...
    private AvlNode<AnyType> findMin( AvlNode<AnyType> t ) {
        if (t == null) return null;           // empty subtree
        if (t.left == null) return t;         // no smaller node
        return findMin(t.left);               // keep going left
    }
